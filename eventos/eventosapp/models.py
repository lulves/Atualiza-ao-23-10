...
class Evento (models.Model):
    ...
    cidade=models.CharField(max_length=150,null= True, blank=False)
    uf = models.CharField(max_length=150,null= True, blank=False)
    endereco =models.CharField(max_length=150,null= True, blank=False)
    def __str__(self):
        return self.nome
